...
from app.schemas.usuarios import Token, auth_response
...
@router.post("/token", response_model=auth_response)
async def login_for_access_token(
    ...
    return auth_response(access_token=access_token, refresh_token=refresh_token, correo_usuario=user.correo_usuario)
